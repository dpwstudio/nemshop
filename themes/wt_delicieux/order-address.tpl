...
<div class="addresses clearfix">
	...
	{if !$opc}
		<div id="ordermsg" class="form-group">
			<label>{l s='If you would like to add a comment about your order, please write it in the field below.'}</label><br/>
			<span><b>{l s='Pour tout paiement à la livraison, veuillez-nous préciser le mode de paiement.'}</b></span>
