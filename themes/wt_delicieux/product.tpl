...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			...
			<section class="page-product-box">
				<div class="block-home-title">
			      <div class="wt-out-title"><h3 class="page-product-heading">{l s='Volume discounts'}</h3></div>
		        </div>
		...
		{if isset($features) && $features}
			...
			<section class="page-product-box">
				 ...
				 <div class="block-home-title">
			          <div class="wt-out-title"><h3 class="page-product-heading">{l s='Data sheet'}</h3></div>
		         </div>
		...
		{if isset($product) && $product->description}
			...
			<section class="page-product-box">
				...
				<div class="block-home-title">
			          <div class="wt-out-title"><h3 class="page-product-heading">{l s='More info'}</h3></div>
		         </div>
				<!-- full description -->
		...
		<section id="blockpack">
			...
			<div class="block-home-title">
			          <div class="wt-out-title"><h3 class="page-product-heading">{l s='Pack content'}</h3></div>
		    </div>
		...
		{if isset($accessories) && $accessories}
			...
			<section class="page-product-box">
				...
				<div class="block-home-title">
			          <div class="wt-out-title"><h3 class="page-product-heading">{l s='Accessories'}</h3></div>
		         </div>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<section class="page-product-box">
				...
				<div class="block-home-title">
			          <div class="wt-out-title"><h3 class="page-product-heading">{l s='Download'}</h3></div>
		         </div>
