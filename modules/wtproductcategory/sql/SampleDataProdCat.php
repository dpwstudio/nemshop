...
class SampleDataProdCat
{
	public function initData()
	{
		...
		(1, "Group category 1", "displayBottomHome", "column", 6, 1, 0, 1);');
		...
		(1, "Group category 1", "'.$id_shop.'", "displayBottomHome", "column", 6, 1, 0, 1);');
		...
		(1, 1, "'.$id_shop.'", 2, "", "", "false", 1, 0, 0, 1),
		(2, 1, "'.$id_shop.'", 3, "", "", "false", 1, 0, 2, 1),
