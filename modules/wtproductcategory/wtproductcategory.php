...
class Wtproductcategory extends Module
{
	...
	public function hookdisplayBottomHome()
	{
		...
		if ($isMobile == 1)
		{
			if (!$this->isCached('wtproductcategory_bottomhome_mobile.tpl', $this->getCacheId('wtproductcategory_bottomhome_mobile')))
			{
			...
			return $this->display(__FILE__, 'wtproductcategory_bottomhome_mobile.tpl', $this->getCacheId('wtproductcategory_bottomhome_mobile'));
		}
		else
		{
