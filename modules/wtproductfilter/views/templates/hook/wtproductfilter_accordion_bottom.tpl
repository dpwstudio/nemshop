...
{foreach from = $product_groups item = product_group name = product_group}
	<div class="{$product_group.class|escape:'html':'UTF-8'} product_list">
		<div class="block-home-title">
			<div class="wt-out-title"><h3>{$product_group.title|escape:'html':'UTF-8'}</h3><p class="block-desc">Menu Description ipsum diam, sed faucibus felis commodo quis</p></div>
