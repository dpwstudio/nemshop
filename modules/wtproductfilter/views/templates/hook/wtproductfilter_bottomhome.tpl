...
<div class="wt-prod-filter wt-filter-bottomhome clearfix">
	<div class="container">
	<div class="block-content">
		{foreach from=$group_prod_fliter item=product_hook name=product_hook}
			{if $product_hook.type_display == 'accordion'}
				{include file="./wtproductfilter_accordion_bottom.tpl" product_groups = $product_hook.product_group prod_img='large_default'}
			{/if}
			...
			{if $product_hook.use_slider == 1}
				...
				{
					$(".wt-filter-bottomhome .owl-prod-filter").owlCarousel({
					  loop: true,
						responsive: {
							0: { items: 1},
