...
class WtBlogLatestNews extends Module
{
	...
	{
		if (!parent::install()
		|| !$this->registerHook('displayBottomHome')
		...
		|| !$this->registerHook('actionsbtogglepost'))
			return false;
		Configuration::updateGlobalValue('wtshowhomepost', 4);
		return true;
	}
	...
	public function hookDisplayBottomHome()
	{
		...
		else
		{
			...
			{
				$view_data['posts'] = WTBlog::getLastestPost($id_lang, $id_shop, Configuration::get('wtshowhomepost'), 'small');
				$this->smarty->assign(array(
