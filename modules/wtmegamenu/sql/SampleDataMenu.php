...
class SampleDataMenu
{
	public function initData()
	{
		...
		(5, 1, 0, 0, "", "wt-sub-auto", "col-sm-12", "", 1);');
		...
		(5, '.$id_shop.', 1, 0, 0, "", "wt-sub-auto", "col-sm-12", "", 1);');
		...
		foreach ($languages as $language)
		{
			...
			(5, '.$id_shop.', '.$language['id_lang'].', "Blog", "index.php?fc=module&module=wtblog&controller=category", "");');
